...
BOTAN_MODULES = aes aes_ssse3 auto_rng asn1 base64 bcrypt bigint block blowfish cbc codec_filt ctr des dh dsa ec_group ecdh ecdsa entropy \
                filters hmac hex hash http_util md5 mode_pad passhash9 pubkey rsa sha1 sha1_sse2 sha1_x86 sha2_32 sha2_32_x86 \
                sha2_64 simd x509 system_rng,emsa_pkcs1,pbes2,pbkdf2
